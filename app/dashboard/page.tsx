        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 w-full px-2 sm:px-0">
          {modulos.map((modulo) => (
            <Link
              key={modulo.href}
              href={modulo.href}
              className={`group relative bg-slate-900/40 backdrop-blur-xl p-6 sm:p-8 rounded-3xl border ${modulo.colorGradient} transition-all duration-300 hover:-translate-y-1.5 ${modulo.hoverGlow} flex flex-col justify-between overflow-hidden`}
            >
