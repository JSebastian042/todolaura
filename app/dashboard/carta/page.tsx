    ...
    <main className="min-h-screen w-full bg-neutral-900 flex flex-col items-center justify-start sm:justify-center p-4 sm:p-8 relative overflow-x-hidden select-none py-10">
      ...
      <div className="relative max-w-2xl w-full bg-[#fbf5e6] text-amber-950 p-6 sm:p-14 rounded-2xl shadow-[0_20px_60px_rgba(0,0,0,0.6),0_0_15px_rgba(217,119,6,0.15)] border-2 border-[#e6d5b8] my-4 sm:my-8 transition-all duration-300">
        ...
        <div className="space-y-4 sm:space-y-6 text-sm sm:text-lg font-serif leading-relaxed text-amber-950/90 text-left sm:text-justify px-1 sm:px-4">
          ...
          <p>
          Cómo lo prometí, antes del jueves teniamos el tercer despliegue de TodoLaura, las modificaciones han sido que agregué el horario y también puse una opción secreta que no la podrás ver hasta que nos veamos por primera vez.
          </p>

          <p>
            Laura cuando hablas en conjunto me parece algo tan maravilloso y hermoso, siempre incluyes mi opinión en las situaciones que ocurren en tu vida y es algo muy gratificante. Quiero ser yo la persona a la que busques cuando sientas que todo se está desmoronando y no sepas que más hacer. Más que tu novio quiero ser tu apoyo incondicional mi ponquesito.
          </p>

          <p>
            He de confesar que cuando me dijiste que ya otra persona sabía sobre mi, como dije ayer significa que esto va avanzando... Significa que el destino se está alineando para que estemos juntos y no nos separemos jamás. 
          </p>

          <p>
            Posdata: Lo mismo de siempre, si quieres alguna otra cosita me avisas que yo con mucho gusto lo hago Laurita, todo lo que sea por ti mi reina preciosa, mi razón, la persona que quiero así y la mujer con la que quiero estar el resto de mi vida.
          </p>
